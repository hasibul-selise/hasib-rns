...
| 9 | **Security of processing** | encryption in transit and at rest, pseudonymisation where it works, access limited to those who need it. Defer sink-level detail to `security-check-fe` / `security-check-be` |
